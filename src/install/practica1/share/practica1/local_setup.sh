...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws_multirobots/src/install/practica1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/practica1/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/practica1/environment/path.sh"
